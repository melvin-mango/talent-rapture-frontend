        ...
        <div className=" relative w-full h-screen" id="home">
            ...
            <div className="w-full p-2 h-full flex flex-col gap-y-10 md:gap-y-20 items-center justify-center border-amber-400 border-0">
                ...
                <div className="flex items-center w-full gap-x-2 justify-center text-sm">
                    <button className="w-1/2 md:w-1/4 lg:w-1/8 xl:w-1/12 items-center justify-center p-2 border rounded-4xl border-white cursor-pointer text-white hover:bg-white hover:text-[#FF7F00] transition-all duration-300 ease-in-out">
                        <span>
                            Get Started
                        </span>
                    </button>
